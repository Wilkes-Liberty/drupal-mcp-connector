...
│   (66 tools)       backends/          Tools · Resources · Prompts  │
│                    + canonical/security                            │
└──────────┬─────────────────────────────────────────────────────────┘
...
### Tools
Callable operations a client invokes on demand. All 66 tools follow the naming convention
