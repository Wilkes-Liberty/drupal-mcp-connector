...
The connector currently delivers **123 tools across 27 modules**, **3 MCP resources**, and **128 MCP prompts** (one per tool, plus 5 workflow prompts), targeting Drupal 10 and 11.
