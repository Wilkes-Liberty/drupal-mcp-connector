...
The connector currently delivers **120 tools across 26 modules**, **3 MCP resources**, and **125 MCP prompts** (one per tool, plus 5 workflow prompts), targeting Drupal 10 and 11.
